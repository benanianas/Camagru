<div class="hp-navbar">
    <div class="logo-side">
        <div id="thelogo" class="logo"><a href="<?php echo URLROOT?>"> <img src="<?php echo URLROOT?>/img/logo.png"></a></div>
    </div>
    <div class="account-buttons">
    <a href="<?php echo URLROOT?>/camera"><i class="fas fa-lg fa-camera-retro"></i></a>
